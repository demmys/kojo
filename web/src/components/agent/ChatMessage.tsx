...
export function MessageContent({
  ...
  const actionButtons = (
    ...
    >
      ...
      {/* Copy button */}
      <button onClick={handleCopy} className={btnCls} title={t("msg.copy")}>
        {copied ? (
  ...
  return (
    <div className="mt-2">
      ...
      >
        ...
        <span>{toolUses.length === 1 ? t("msg.toolOne") : t("msg.toolMany", { count: toolUses.length })}</span>
